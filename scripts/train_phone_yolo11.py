...
DEFAULT_DATA = PROJECT_ROOT / "phone_yolo" / "data.yaml"
DEFAULT_OUTPUT_MODEL = PROJECT_ROOT / "models" / "phone_yolo11.pt"


def parse_args():
    parser = argparse.ArgumentParser(description="Train the local YOLO11 phone detector.")
    ...
    parser.add_argument("--project", default=str(PROJECT_ROOT / "runs" / "phone_yolo"))
    parser.add_argument("--name", default="yolo11_phone")
...
def main():
    ...
    print(f"Saved trained phone model: {out_path}")
